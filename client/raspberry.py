...
thermostat_1_component_name = "Sensor" #"thermostat1"
...
async def main():
    ...
    async def send_telemetry():
        ...
        while True:
            ...
            workingset_msg2 = {"workingSet": random.randrange(1, 100)}
            await send_telemetry_from_temp_controller(device_client, workingset_msg2)
